...
namespace rapid
{
  typedef TopicPairApp_T<ext::TrajectoryConfig, ext::TrajectorySample, ext::TrajectoryTopicPairParameters> TopicPairApp;
}
...
{
  ext::TrajectoryTopicPairParameters params;
  TopicPairApp app(argc, argv, params);

  app.run(ext::TRAJECTORY_CONFIG_TOPIC, ext::TRAJECTORY_SAMPLE_TOPIC);
