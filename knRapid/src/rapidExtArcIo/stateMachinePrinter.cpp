...
namespace rapid
{
  typedef TopicPairApp_T<ext::arc::StateMachineConfig, ext::arc::StateMachineState, ext::arc::StateMachineTopicPairParameters> TopicPairApp;
}
...
{
  ext::arc::StateMachineTopicPairParameters params;
  TopicPairApp app(argc, argv, params);

  app.run(ext::arc::STATEMACHINE_CONFIG_TOPIC, ext::arc::STATEMACHINE_STATE_TOPIC);
