...
GenericConfigPluginSupport_create_data_w_params(
    ...
    GenericConfig *sample = NULL;

    RTIOsapiHeap_allocateStructure(
        &sample, GenericConfig);

    if(sample != NULL) {
        if (!::rapid::ext::arc::GenericConfig_initialize_w_params(sample,alloc_params)) {
...
GenericConfigPluginSupport_create_data_ex(RTIBool allocate_pointers){
    ...
    if(sample != NULL) {
        if (!::rapid::ext::arc::GenericConfig_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
            RTIOsapiHeap_freeStructure(sample);
            return NULL;
        }
    }        
...
{
    return ::rapid::ext::arc::GenericConfigPluginSupport_create_data_ex(RTI_TRUE);
}
...
GenericConfigPluginSupport_destroy_data_w_params(
    ...
    ::rapid::ext::arc::GenericConfig_finalize_w_params(sample,dealloc_params);
...
GenericConfigPluginSupport_destroy_data_ex(
    ...
    ::rapid::ext::arc::GenericConfig_finalize_ex(sample,deallocate_pointers);
...
GenericConfigPluginSupport_destroy_data(
    ...
    ::rapid::ext::arc::GenericConfigPluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return ::rapid::ext::arc::GenericConfig_copy(dst,src);
}
...
GenericConfigPluginSupport_create_key_ex(RTIBool allocate_pointers){
    GenericConfig *key = NULL;

    RTIOsapiHeap_allocateStructure(
        &key, GenericConfigKeyHolder);

    ::rapid::ext::arc::GenericConfig_initialize_ex(key,allocate_pointers,RTI_TRUE);
    return key;
}
...
{
    return  ::rapid::ext::arc::GenericConfigPluginSupport_create_key_ex(RTI_TRUE);
}
...
{
    ::rapid::ext::arc::GenericConfig_finalize_ex(key,deallocate_pointers);
...
GenericConfigPluginSupport_destroy_key(
  ...
  ::rapid::ext::arc::GenericConfigPluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
            ...
            ::rapid::ext::arc::GenericConfigPluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            ::rapid::ext::arc::GenericConfigPluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            ::rapid::ext::arc::GenericConfigPluginSupport_create_key,
            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            ::rapid::ext::arc::GenericConfigPluginSupport_destroy_key);

    if (epd == NULL) {
        return NULL;
    }
   
    serializedKeyMaxSize = ::rapid::ext::arc::GenericConfigPlugin_get_serialized_key_max_size(
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = ::rapid::ext::arc::GenericConfigPlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                ::rapid::ext::arc::GenericConfigPlugin_get_serialized_sample_max_size, epd,
            (PRESTypePluginGetSerializedSampleSizeFunction)
            ::rapid::ext::arc::GenericConfigPlugin_get_serialized_sample_size,
            epd) == RTI_FALSE) {
            PRESTypePluginDefaultEndpointData_delete(epd);
            return NULL;
        }
    ...
    void *handle)
{
    ...
    GenericConfig_finalize_optional_members(sample, RTI_TRUE);
    ...
    const GenericConfig *src)
{
    ...
    return ::rapid::ext::arc::GenericConfigPluginSupport_copy_data(dst,src);
}
    ...
    void *endpoint_plugin_qos)
{
    ...
    if(deserialize_sample) {
        ::rapid::ext::arc::GenericConfig_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
    ...
    void *endpoint_plugin_qos)
{
    ...
    result = ::rapid::ext::arc::GenericConfigPlugin_deserialize_sample( 
...
RTIBool GenericConfigPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
...
RTIBool GenericConfigPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    GenericConfig *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
RTIBool GenericConfigPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    GenericConfig **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
    ...
    void *endpoint_plugin_qos)
{
    ...
    result = ::rapid::ext::arc::GenericConfigPlugin_deserialize_key_sample(
...
GenericConfigPlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    GenericConfig *dst, const
    GenericConfigKeyHolder *src)
{
    ...
    const GenericConfig *instance)
{
    ...
    if (!::rapid::ext::arc::GenericConfigPlugin_serialize_key(
...
fin:
    ...
    if (!::rapid::ext::arc::GenericConfigPlugin_instance_to_keyhash(
...
struct PRESTypePlugin *GenericConfigPlugin_new(void) 
{ 
    ...
    plugin->onParticipantAttached =
        ...
        ::rapid::ext::arc::GenericConfigPlugin_on_participant_attached;
    plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        ::rapid::ext::arc::GenericConfigPlugin_on_participant_detached;
    plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        ::rapid::ext::arc::GenericConfigPlugin_on_endpoint_attached;
    plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        ::rapid::ext::arc::GenericConfigPlugin_on_endpoint_detached;

    plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        ::rapid::ext::arc::GenericConfigPlugin_copy_sample;
    plugin->createSampleFnc =
        (PRESTypePluginCreateSampleFunction)
        GenericConfigPlugin_create_sample;
    plugin->destroySampleFnc =
        (PRESTypePluginDestroySampleFunction)
        GenericConfigPlugin_destroy_sample;

    plugin->serializeFnc =
        (PRESTypePluginSerializeFunction)
        ::rapid::ext::arc::GenericConfigPlugin_serialize;
    plugin->deserializeFnc =
        (PRESTypePluginDeserializeFunction)
        ::rapid::ext::arc::GenericConfigPlugin_deserialize;
    plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        ::rapid::ext::arc::GenericConfigPlugin_get_serialized_sample_max_size;
    plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        ::rapid::ext::arc::GenericConfigPlugin_get_serialized_sample_min_size;


    plugin->getSampleFnc =
        (PRESTypePluginGetSampleFunction)
        GenericConfigPlugin_get_sample;
    ...
    plugin->getKeyKindFnc =
        ...
        ::rapid::ext::arc::GenericConfigPlugin_get_key_kind;


    plugin->getSerializedKeyMaxSizeFnc =   
        (PRESTypePluginGetSerializedKeyMaxSizeFunction)
        ::rapid::ext::arc::GenericConfigPlugin_get_serialized_key_max_size;
    plugin->serializeKeyFnc =
        (PRESTypePluginSerializeKeyFunction)
        ::rapid::ext::arc::GenericConfigPlugin_serialize_key;
    plugin->deserializeKeyFnc =
        (PRESTypePluginDeserializeKeyFunction)
        ::rapid::ext::arc::GenericConfigPlugin_deserialize_key;
    plugin->deserializeKeySampleFnc =
        (PRESTypePluginDeserializeKeySampleFunction)
        ::rapid::ext::arc::GenericConfigPlugin_deserialize_key_sample;

    plugin->instanceToKeyHashFnc = 
        (PRESTypePluginInstanceToKeyHashFunction)
        ::rapid::ext::arc::GenericConfigPlugin_instance_to_keyhash;
    plugin->serializedSampleToKeyHashFnc = 
        (PRESTypePluginSerializedSampleToKeyHashFunction)
        ::rapid::ext::arc::GenericConfigPlugin_serialized_sample_to_keyhash;

    plugin->getKeyFnc =
        (PRESTypePluginGetKeyFunction)
        GenericConfigPlugin_get_key;
    plugin->returnKeyFnc =
        (PRESTypePluginReturnKeyFunction)
        GenericConfigPlugin_return_key;

    plugin->instanceToKeyFnc =
        (PRESTypePluginInstanceToKeyFunction)
        ::rapid::ext::arc::GenericConfigPlugin_instance_to_key;
    plugin->keyToInstanceFnc =
        (PRESTypePluginKeyToInstanceFunction)
        ::rapid::ext::arc::GenericConfigPlugin_key_to_instance;
    plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
    
    plugin->typeCode =  (struct RTICdrTypeCode *)::rapid::ext::arc::GenericConfig_get_typecode();
    ...
    plugin->getBuffer = 
        ...
        GenericConfigPlugin_get_buffer;
    plugin->returnBuffer = 
        (PRESTypePluginReturnBufferFunction)
        GenericConfigPlugin_return_buffer;
    plugin->getSerializedSampleSizeFnc =
        (PRESTypePluginGetSerializedSampleSizeFunction)
        ::rapid::ext::arc::GenericConfigPlugin_get_serialized_sample_size;

    plugin->endpointTypeName = GenericConfigTYPENAME;

    return plugin;
}

void
GenericConfigPlugin_delete(struct PRESTypePlugin *plugin)
{
