...
TrajectoryConfigPluginSupport_create_data_w_params(
    ...
    TrajectoryConfig *sample = NULL;

    RTIOsapiHeap_allocateStructure(
        &sample, TrajectoryConfig);

    if(sample != NULL) {
        if (!::rapid::ext::TrajectoryConfig_initialize_w_params(sample,alloc_params)) {
...
TrajectoryConfigPluginSupport_create_data_ex(RTIBool allocate_pointers){
    ...
    if(sample != NULL) {
        if (!::rapid::ext::TrajectoryConfig_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
            RTIOsapiHeap_freeStructure(sample);
            return NULL;
        }
    }        
...
{
    return ::rapid::ext::TrajectoryConfigPluginSupport_create_data_ex(RTI_TRUE);
}
...
TrajectoryConfigPluginSupport_destroy_data_w_params(
    ...
    ::rapid::ext::TrajectoryConfig_finalize_w_params(sample,dealloc_params);
...
TrajectoryConfigPluginSupport_destroy_data_ex(
    ...
    ::rapid::ext::TrajectoryConfig_finalize_ex(sample,deallocate_pointers);
...
TrajectoryConfigPluginSupport_destroy_data(
    ...
    ::rapid::ext::TrajectoryConfigPluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return ::rapid::ext::TrajectoryConfig_copy(dst,src);
}
...
TrajectoryConfigPluginSupport_create_key_ex(RTIBool allocate_pointers){
    TrajectoryConfig *key = NULL;

    RTIOsapiHeap_allocateStructure(
        &key, TrajectoryConfigKeyHolder);

    ::rapid::ext::TrajectoryConfig_initialize_ex(key,allocate_pointers,RTI_TRUE);
    return key;
}
...
{
    return  ::rapid::ext::TrajectoryConfigPluginSupport_create_key_ex(RTI_TRUE);
}
...
{
    ::rapid::ext::TrajectoryConfig_finalize_ex(key,deallocate_pointers);
...
TrajectoryConfigPluginSupport_destroy_key(
  ...
  ::rapid::ext::TrajectoryConfigPluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
            ...
            ::rapid::ext::TrajectoryConfigPluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            ::rapid::ext::TrajectoryConfigPluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            ::rapid::ext::TrajectoryConfigPluginSupport_create_key,
            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            ::rapid::ext::TrajectoryConfigPluginSupport_destroy_key);

    if (epd == NULL) {
        return NULL;
    }
   
    serializedKeyMaxSize = ::rapid::ext::TrajectoryConfigPlugin_get_serialized_key_max_size(
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = ::rapid::ext::TrajectoryConfigPlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                ::rapid::ext::TrajectoryConfigPlugin_get_serialized_sample_max_size, epd,
            (PRESTypePluginGetSerializedSampleSizeFunction)
            ::rapid::ext::TrajectoryConfigPlugin_get_serialized_sample_size,
            epd) == RTI_FALSE) {
            PRESTypePluginDefaultEndpointData_delete(epd);
            return NULL;
        }
    ...
    void *handle)
{
    ...
    TrajectoryConfig_finalize_optional_members(sample, RTI_TRUE);
    ...
    const TrajectoryConfig *src)
{
    ...
    return ::rapid::ext::TrajectoryConfigPluginSupport_copy_data(dst,src);
}
    ...
    void *endpoint_plugin_qos)
{
    ...
    if(deserialize_sample) {
        ::rapid::ext::TrajectoryConfig_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
    ...
    void *endpoint_plugin_qos)
{
    ...
    result = ::rapid::ext::TrajectoryConfigPlugin_deserialize_sample( 
...
RTIBool TrajectoryConfigPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
...
RTIBool TrajectoryConfigPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    TrajectoryConfig *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
RTIBool TrajectoryConfigPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    TrajectoryConfig **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
    ...
    void *endpoint_plugin_qos)
{
    ...
    result = ::rapid::ext::TrajectoryConfigPlugin_deserialize_key_sample(
...
TrajectoryConfigPlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    TrajectoryConfig *dst, const
    TrajectoryConfigKeyHolder *src)
{
    ...
    const TrajectoryConfig *instance)
{
    ...
    if (!::rapid::ext::TrajectoryConfigPlugin_serialize_key(
...
fin:
    ...
    if (!::rapid::ext::TrajectoryConfigPlugin_instance_to_keyhash(
...
struct PRESTypePlugin *TrajectoryConfigPlugin_new(void) 
{ 
    ...
    plugin->onParticipantAttached =
        ...
        ::rapid::ext::TrajectoryConfigPlugin_on_participant_attached;
    plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        ::rapid::ext::TrajectoryConfigPlugin_on_participant_detached;
    plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        ::rapid::ext::TrajectoryConfigPlugin_on_endpoint_attached;
    plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        ::rapid::ext::TrajectoryConfigPlugin_on_endpoint_detached;

    plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        ::rapid::ext::TrajectoryConfigPlugin_copy_sample;
    plugin->createSampleFnc =
        (PRESTypePluginCreateSampleFunction)
        TrajectoryConfigPlugin_create_sample;
    plugin->destroySampleFnc =
        (PRESTypePluginDestroySampleFunction)
        TrajectoryConfigPlugin_destroy_sample;

    plugin->serializeFnc =
        (PRESTypePluginSerializeFunction)
        ::rapid::ext::TrajectoryConfigPlugin_serialize;
    plugin->deserializeFnc =
        (PRESTypePluginDeserializeFunction)
        ::rapid::ext::TrajectoryConfigPlugin_deserialize;
    plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        ::rapid::ext::TrajectoryConfigPlugin_get_serialized_sample_max_size;
    plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        ::rapid::ext::TrajectoryConfigPlugin_get_serialized_sample_min_size;


    plugin->getSampleFnc =
        (PRESTypePluginGetSampleFunction)
        TrajectoryConfigPlugin_get_sample;
    ...
    plugin->getKeyKindFnc =
        ...
        ::rapid::ext::TrajectoryConfigPlugin_get_key_kind;


    plugin->getSerializedKeyMaxSizeFnc =   
        (PRESTypePluginGetSerializedKeyMaxSizeFunction)
        ::rapid::ext::TrajectoryConfigPlugin_get_serialized_key_max_size;
    plugin->serializeKeyFnc =
        (PRESTypePluginSerializeKeyFunction)
        ::rapid::ext::TrajectoryConfigPlugin_serialize_key;
    plugin->deserializeKeyFnc =
        (PRESTypePluginDeserializeKeyFunction)
        ::rapid::ext::TrajectoryConfigPlugin_deserialize_key;
    plugin->deserializeKeySampleFnc =
        (PRESTypePluginDeserializeKeySampleFunction)
        ::rapid::ext::TrajectoryConfigPlugin_deserialize_key_sample;

    plugin->instanceToKeyHashFnc = 
        (PRESTypePluginInstanceToKeyHashFunction)
        ::rapid::ext::TrajectoryConfigPlugin_instance_to_keyhash;
    plugin->serializedSampleToKeyHashFnc = 
        (PRESTypePluginSerializedSampleToKeyHashFunction)
        ::rapid::ext::TrajectoryConfigPlugin_serialized_sample_to_keyhash;

    plugin->getKeyFnc =
        (PRESTypePluginGetKeyFunction)
        TrajectoryConfigPlugin_get_key;
    plugin->returnKeyFnc =
        (PRESTypePluginReturnKeyFunction)
        TrajectoryConfigPlugin_return_key;

    plugin->instanceToKeyFnc =
        (PRESTypePluginInstanceToKeyFunction)
        ::rapid::ext::TrajectoryConfigPlugin_instance_to_key;
    plugin->keyToInstanceFnc =
        (PRESTypePluginKeyToInstanceFunction)
        ::rapid::ext::TrajectoryConfigPlugin_key_to_instance;
    plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
    
    plugin->typeCode =  (struct RTICdrTypeCode *)::rapid::ext::TrajectoryConfig_get_typecode();
    ...
    plugin->getBuffer = 
        ...
        TrajectoryConfigPlugin_get_buffer;
    plugin->returnBuffer = 
        (PRESTypePluginReturnBufferFunction)
        TrajectoryConfigPlugin_return_buffer;
    plugin->getSerializedSampleSizeFnc =
        (PRESTypePluginGetSerializedSampleSizeFunction)
        ::rapid::ext::TrajectoryConfigPlugin_get_serialized_sample_size;

    plugin->endpointTypeName = TrajectoryConfigTYPENAME;

    return plugin;
}

void
TrajectoryConfigPlugin_delete(struct PRESTypePlugin *plugin)
{
