...
void HelloWorldListener::on_sample_rejected(DDSDataReader* /*reader*/,
    const DDS_SampleRejectedStatus& /*status*/)
{
  fprintf(stderr, "----> on_sample_rejected\n");
}

void HelloWorldListener::on_liveliness_changed(
  DDSDataReader* /*reader*/,
  const DDS_LivelinessChangedStatus& /*status*/)
{
  fprintf(stderr, "----> on_liveliness_changed\n");
}

void HelloWorldListener::on_sample_lost(
  DDSDataReader* /*reader*/,
  const DDS_SampleLostStatus& /*status*/)
{
  fprintf(stderr, "----> on_sample_lost\n");
}
...
void HelloWorldListener::on_subscription_matched(
  ...
  const DDS_SubscriptionMatchedStatus& /*status*/)
{
  fprintf(stderr, "----> on_subscription_matched\n");
}


void HelloWorldListener::on_requested_incompatible_qos(
  DDSDataReader* /*reader*/,
  const DDS_RequestedIncompatibleQosStatus& status)
{
  fprintf(stderr, "----> on_requested_incompatible_qos\n");
  fprintf(stderr, "      last_policy_id = %d", status.last_policy_id);
}

void HelloWorldListener::on_requested_deadline_missed(
  DDSDataReader* /*reader*/,
  const DDS_RequestedDeadlineMissedStatus& /*status*/)
{
  fprintf(stderr, "---> on_requested_deadline_missed\n");
}
...
extern "C" int subscriber_main(int domainId, int sample_count)
{
  ...
  //-- ndds.4.3e/doc/html/api_cpp/index.html
  ...
  //-------------------------------------------------------------
  //-- set Qos
  // NOTE: Make sure struct is initialized by
  // subscriber default so we don't get garbage
  //-------------------------------------------------------------
  ...
  dr_qos.history.depth = 10; // 10 samples
