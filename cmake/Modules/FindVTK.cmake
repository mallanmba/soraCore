...
if(NOT VTK_DIR)
  find_path(VTK_DIR VTKConfig.cmake
            PATH_SUFFIXES lib lib/vtk
            HINTS
            ${VTK_ROOT_DIR}
            $ENV{VTK_ROOT}
            ${IRG_PACKAGES_DIR}/VTK
            ${IRG_PACKAGES_DIR}/vtk)
endif(NOT VTK_DIR)
...
if(VTK_FOUND)
  message(STATUS "Found VTK version - VTK_DIR=${VTK_MAJOR_VERSION}.${VTK_MINOR_VERSION}.${VTK_BUILD_VERSION} in ${VTK_DIR}")
  set(VTK_INCLUDE_DIR ${VTK_INCLUDE_DIRS})
  set(VTK_LIBRARY_DIR ${VTK_LIBRARY_DIRS})
endif(VTK_FOUND)
