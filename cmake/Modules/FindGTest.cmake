######################################################################
# Find script for Google C++ Testing Framework
#
# Used to set GTEST_ROOT to look for GTest in irg packages
# find_package(GTest) will then set the following 
#
# Output Variables:
# -----------------
...
#
# Note: for more details refer to cmake --help-module FindGTest
#
######################################################################
...
if (NOT GTEST_ROOT )
	...
	message (STATUS "setting GTEST_ROOT to ${GTEST_ROOT}")
endif (NOT GTEST_ROOT )

## duplicate of file FindGTest.cmake from cmake version 2.8.2 
