...
extern "C" int publisher_main(int sample_size, int sample_count)
{
    ...
    int count = 0;  
    struct DDS_Duration_t send_period = {0, 800000000};
...
*/
    ...
    /* Main loop */
    int current_size = 4000;
    instance->buffer.maximum(sample_size);
	...
	sprintf(instance->msg, "Hello World! (%d)", count);
        instance->buffer.length(current_size);
...
int main(int argc, char *argv[])
{
    ...
    int sample_count = 50; /* infinite loop */
    ...
    return publisher_main(sample_size, sample_count);
}
